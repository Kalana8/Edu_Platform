    ...
    <div className="min-h-screen bg-slate-50 text-slate-950">
      <main className="mx-auto flex min-h-screen w-full max-w-[390px] flex-col justify-center px-4 py-8">
        <div className="space-y-4 text-center">
          ...
          <div className="mx-auto max-w-xl rounded-3xl border border-slate-200 bg-slate-100/80 p-5 text-left text-sm text-slate-600 shadow-sm">
        ...
        <div className="mt-8 space-y-5">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-3xl border border-slate-200 bg-white p-4 text-base text-slate-900 outline-none ring-1 ring-transparent transition focus:border-slate-300 focus:ring-slate-200"
            />
          </div>
