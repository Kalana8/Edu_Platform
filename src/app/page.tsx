    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(59,130,246,.35),_transparent_25%),linear-gradient(180deg,#4f46e5_0%,#8b5cf6_45%,#9333ea_100%)] text-white">
      <main className="relative mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <div className="flex w-full flex-col items-center gap-4 justify-center">
          <Link
            className="inline-flex h-14 min-w-[12rem] items-center justify-center rounded-lg bg-white px-8 text-base font-semibold text-slate-950 shadow-lg shadow-slate-950/10 transition hover:shadow-slate-950/20"
            href="/join-school"
          >
            Get Started
          </Link>
          <Link
            className="inline-flex h-14 min-w-[12rem] items-center justify-center rounded-lg border border-white/50 bg-white/10 px-8 text-base font-semibold text-white transition hover:bg-white/15"
            href="/admin/login"
          >
            Admin Login →
          </Link>
