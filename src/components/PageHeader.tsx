...
export default function PageHeader({
  ...
  return (
    <section className={`overflow-hidden ${radiusClass} bg-gradient-to-r ${gradientClass} px-5 ${paddingClass} pb-5 text-white shadow-lg shadow-slate-950/10 ${className}`}>
